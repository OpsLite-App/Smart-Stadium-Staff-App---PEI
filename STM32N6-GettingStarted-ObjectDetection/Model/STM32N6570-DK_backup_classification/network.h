...
#define LL_ATON_NETWORK_ORIGIN_MODEL_NAME   "zip_224_ebc_n_PerTensor_quant_random_2"
...
// Output buffer 1 -- Quantize_232_out_0
#define LL_ATON_NETWORK_OUT_1_ALIGNMENT   (32)
#define LL_ATON_NETWORK_OUT_1_SIZE_BYTES  (784)
